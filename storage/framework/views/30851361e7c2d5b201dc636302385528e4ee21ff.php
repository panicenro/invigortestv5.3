...
<div class="text-left"><h1>Products</h1></div><div class="text-right"><a href="<?php echo e(action('ProductsController@create')); ?>" class="btn btn-primary" name="Add_0" id="Add_0">Add New Product</a></div>
